...
const CULTIVATE_SYSTEM_PROMPT = `You translate someone's plain-language planting/growing request in a spatial editor (Rhombiverse) into a small structured plan.

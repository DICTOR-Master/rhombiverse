// Verifies src/app/i18n.js's own real shipped state, matching
// Polyhedraverse's scripts/verify-i18n.ts (same checks, ported to this
// project's plain-Node/no-test-framework convention): every language
// has exactly English's key set (no missing, no extra), every value is
// non-empty, and t() actually returns what the dictionary holds.
import { __I18N_FOR_VERIFY_ONLY__ as I18N, LANG_ORDER, LANG_META, t } from '../src/app/i18n.js';
